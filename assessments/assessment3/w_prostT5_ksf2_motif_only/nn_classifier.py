...
class BilinearFeatureModule(nn.Module):
    ...
    def forward(self, k_emb, m_emb, k_st, s_st):
        out2 = self.bilinear2(k_emb, m_emb)
        out3 = self.bilinear3(k_st,s_st)
        combined = self.bilinear4(out2,out3)
        return combined
...
class BilinearDNNModel(nn.Module):
    ...
    def forward(self, k_emb, m_emb, k_st, s_st):
        combined_features = self.bilinear_module(k_emb, m_emb, k_st, s_st)
...
class KSFinder2:
    ...
    def __init__(self,training_data):        
        ...
        self.train_data_args = {'k_emb':k_emb_train, 'm_emb':m_emb_train,
...
if __name__ == '__main__':
    ...
    model_path = constants.MODEL_STRUCT_MOTIF
