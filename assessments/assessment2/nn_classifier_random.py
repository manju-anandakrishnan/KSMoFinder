...
from embeddings import RandomDataLoader, RandomEmbeddings
                    ...
                    for epoch in range(num_epochs):
                        ...
                        if (epoch+1)%1 == 0:
                            ...
                            if pr_score > best_score:
                                ...
                                patience_count += 1
                                if patience_count == 3:
                                    model_fold_epochs[fold]=epoch-3*1
...
if __name__ == '__main__':
    ...
    raw_testing_data = data_loader.get_testing_data(constants.CSV_CLF_TEST_D1_ASSESS2)
    ...
    raw_testing_data = data_loader.get_testing_data(constants.CSV_CLF_TEST_D2_ASSESS2)
    testing_data = ksm_embeddings.get_testing_data(raw_testing_data)
