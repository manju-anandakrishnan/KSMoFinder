...
from embeddings import ESM3DataLoader, ESM3Embeddings
...
class KSFinder2:
    '''
    Class for training KSFinder2 using ESM3 embeddings
    ...
    def train_model(self):
        ...
        param_combinations = [     
            {'hidden_sizes': [80,90], 'learning_rate':0.0001},
        ...
        for param_comb in param_combinations:
            ...
            results.append({'params': param_comb, 
                                'median_score':max_score})
        print(results)
        best_model = max(results, key=lambda x: x['median_score'])
...
if __name__ == '__main__':
    ...
    model_path = constants.MODEL_ESM3
    ...
    data_loader = ESM3DataLoader()

    # Loads ESM3 embeddings
    ksm_embeddings = ESM3Embeddings()
