...
wget https://zenodo.org/records/15271711/files/kg_data.zip
unzip kg_data.zip
rm kg_data.zip

## Download embeddings
cd $KSFINDER2_HOME_DIR/data/embeddings
wget https://zenodo.org/records/15271711/files/embeddings.zip
unzip embeddings.zip
rm embeddings.zip

## Download classification assessment datasets, kg kinases and substrate_motifs
cd $KSFINDER2_HOME_DIR/data
wget https://zenodo.org/records/15271711/files/classifier_datasets.zip
unzip classifier_datasets.zip
rm classifier_datasets.zip

wget https://zenodo.org/records/15271711/files/assessment_datasets.zip
unzip assessment_datasets.zip
rm assessment_datasets.zip

wget https://zenodo.org/records/15271711/files/kg_ks.zip
unzip kg_ks.zip
rm kg_ks.zip

## Download assessment1 models
cd $KSFINDER2_HOME_DIR/assessments/assessment1
wget https://zenodo.org/records/15271711/files/kge_models_assess1.zip
...
wget https://zenodo.org/records/15271711/files/models_assess2.zip
unzip models_assess2.zip
rm models_assess2.zip

## Download assessment3 models
cd $KSFINDER2_HOME_DIR/assessments/assessment3
wget https://zenodo.org/records/15271711/files/models_assess3.zip
...
wget https://zenodo.org/records/15271711/files/other_model_predictions.zip
...
wget https://zenodo.org/records/15271711/files/ksf2_predictions.zip

cd $KSFINDER2_HOME_DIR/model
## Download KSFinder 2.0
wget https://zenodo.org/records/15271711/files/model_ksfinder2.zip
